      ...
      >
        ...
        <div className="mb-8">
          ...
          <motion.div variants={fadeInUp} className="overflow-hidden">
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-[1.1]">
              <span
                className="bg-clip-text text-transparent bg-gradient-to-r from-primary-600 via-violet-500 to-cyan-500 animate-gradient-shift"
        ...
        >
          <span className="text-primary font-semibold">
            AI-Native Business Process Designer
          </span>
...
function HeroBackground() {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {/* Base gradient — top starts at #faf8ff to match QuotesIntro bottom */}
      <div
        ...
        style={{
          background: `
            ...
            linear-gradient(180deg, #faf8ff 0%, #fdfcff 15%, #ffffff 40%, #f8faff 100%)
          `,
        }}
      />

      {/* Top blend overlay — ensures seamless transition */}
      <div
        className="absolute top-0 left-0 right-0 h-48 z-[1]"
        style={{
          background: 'linear-gradient(180deg, #faf8ff 0%, #faf8ff 20%, transparent 100%)',
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(79, 70, 229, 0.04) 0%, transparent 50%)',
        }}
      />
    </div>
  )
